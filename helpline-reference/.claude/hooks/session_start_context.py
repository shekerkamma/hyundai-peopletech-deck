...
def _force_utf8() -> None:
    """Emit UTF-8 regardless of the Windows console code page — this block is
    injected into Claude's context, so it must not be mangled by cp1252."""
...
def main() -> None:
    ...
    lines = ["## Helpline — session orientation", ""]
